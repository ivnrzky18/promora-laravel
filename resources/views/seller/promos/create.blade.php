...
<div class="max-w-3xl space-y-6">
    ...
    <div class="flex items-center space-x-3">
        ...
        <div>
            ...
            <p class="text-gray-500 mt-0.5 text-sm">Buat promo baru untuk bisnis Anda</p>
        </div>
    </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 divide-y divide-gray-100">
            ...
            <div class="p-6 space-y-4">
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="4"
                              ...
                              placeholder="Jelaskan detail promo Anda...">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="p-6 space-y-4">
                ...
                <div>
                    ...
                    <button type="button" x-show="imagePreview" @click="imagePreview = null; $el.previousElementSibling.querySelector('input').value = ''"
